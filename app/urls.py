...
from .views import home, contacto, galeria, agregar_producto, listar_producto, modificar_producto, eliminar_producto, registro,  agregar_producto_car, eliminar_producto_car,restar_producto, limpiar_carrito, carrito, ProductoListCreate
urlpatterns = [
    path('', home, name="home"),
